  ...
  users: [
    {
      ...
      name: 'Elon Musk',
      password:
        '$argon2id$v=19$m=4096,t=3,p=1$yaI2A57+PSJLiY3uNF6ojQ$rp23mlTRg6k0evpGjWojQeZroiXYc1guivBAY90Id/0',
      role: 'admin'
    },
    {
      email: 'fernanod@google.com',
      name: 'Fernando Herrera',
      password:
        '$argon2id$v=19$m=4096,t=3,p=1$jdbFq7Sa4LkUtfl25t0BKA$Rp1nyp2AQmjYHTMv13yNmpWUREUcqqpfZwVhzV9PNd8',
      role: 'client'
    }
  ]
};
